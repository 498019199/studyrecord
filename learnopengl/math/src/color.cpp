...
{
    R = static_cast<uint8_t>(std::clamp(this->r(), T(0), T(1)) * 255 + 0.5f);
    G = static_cast<uint8_t>(std::clamp(this->g(), T(0), T(1)) * 255 + 0.5f);
    B = static_cast<uint8_t>(std::clamp(this->b(), T(0), T(1)) * 255 + 0.5f);
    A = static_cast<uint8_t>(std::clamp(this->a(), T(0), T(1)) * 255 + 0.5f);
}
